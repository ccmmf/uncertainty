...
**PFT Mapping:** - `annual crop` → `grass` - `woody perennial crop` → `temperate.deciduous`
...
**Key settings:** - Ensemble size: 20 (parameters) x 10 (met) - Simulation period: 2016–2023 - Sigma levels: ±1σ, ±2σ perturbations
